...
class epornerGenreScreen(MPScreen):
	...
	def genreData(self, data):
		...
		if Cats:
			...
			self.genreliste.insert(0, ("Longest", "http://www.eporner.com/category/all/SORT-longest/", None))
			self.genreliste.insert(0, ("Top Rated", "http://www.eporner.com/category/all/SORT-top-rated/", None))
			self.genreliste.insert(0, ("Most Viewed", "http://www.eporner.com/category/all/SORT-most-viewed/", None))
			self.genreliste.insert(0, ("Most Recent", "http://www.eporner.com/category/all/", None))
